						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="导出到EXCEL" onclick="download()">
...
<%--												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/selectById.do?id=${orders.id}'">编辑</button>--%>
											</td>
										</tr>
									</c:forEach>
								</tbody>
	...
	<script>
		...
		function download(){
			var url="${pageContext.request.contextPath}/orders/download_excel.do";
			window.open(url);
		}
