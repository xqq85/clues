...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form:form modelAttribute="product" action="${pageContext.request.contextPath}/product/save.do"
				method="post">
				<!-- 正文区域 -->
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="productNumber"
								placeholder="产品编号（唯一）" value="${product.productNumber}">
						</div>
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="location"
								   placeholder="产地" value="${product.location}">
						</div>
						<div class="col-md-6 data">
						...
						<div class="col-md-4 data">
							<div class="input-group date">
								...
								<input type="text" class="form-control pull-right"
									id="datepicker-a3" name="productTime">
							</div>
						</div>
						<div class="col-md-6 data">
							<form:errors path="productTime" cssStyle="color:red"/>
						</div>
