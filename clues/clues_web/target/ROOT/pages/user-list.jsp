	...
	<div class="wrapper">
									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/findById1.do?id=${user.id}" class="btn bg-olive btn-xs">修改</a>
		...
		<script>
			...
			function deleteUser() {
				...
				//向服务器发送请求，删除用户
				location.href = "${pageContext.request.contextPath}/user/deleteUser.do?ids="
						+ arr;
			};
